...
export const SocketContextProvider = ({
    ...
    const [ganaBaja , setGanaBaja] = useState(false);
    ...
    return (
        <SocketContext.Provider value={{ onlineUsers, handleCall, ongoingCall, localStream, handleJoin , peer , handleHangUp , isCallEnded}}>
            {children}
